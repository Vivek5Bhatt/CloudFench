...
const NotificationDropdown = () => {
  ...
  return (
    <Fragment>
      <IconButton color='inherit' aria-haspopup='true' aria-controls='customized-menu' sx={{
        padding: "6px",
      }} onClick={() => handleRoute('/admin/settings/connectors')}>
        <SettingsOutlinedIcon sx={{ fontSize: "20px" }} />
      </IconButton>
      <IconButton color='inherit' aria-haspopup='true' onClick={handleDropdownOpen} aria-controls='customized-menu' sx={{
        padding: "6px",
      }} >
        <BellOutline sx={{ fontSize: "20px" }} />
      </IconButton>
      <Menu
        anchorEl={anchorEl}
